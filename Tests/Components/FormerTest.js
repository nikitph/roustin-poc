...
import Former from '../../App/Components/Former'

const wrapper = shallow(<Former />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('Former Component')) // That the Component Text is included
})
