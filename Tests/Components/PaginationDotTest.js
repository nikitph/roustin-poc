...
import PaginationDot from '../../App/Components/PaginationDot'

const wrapper = shallow(<PaginationDot />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('PaginationDot Component')) // That the Component Text is included
})
